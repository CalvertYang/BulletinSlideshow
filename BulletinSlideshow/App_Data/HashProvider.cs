...
namespace Apputu.Library
{
    public class HashProvider
    {
        ...
        /// Salt value. This parameter can be null, in which case a random salt
                                         ...
                                         string saltValue)
        {
            ...
            {
                saltBytes = System.Text.Encoding.Default.GetBytes(saltValue);
            }
                                      ...
                                      string hashValue)
        {
            ...
            string saltValue = System.Text.Encoding.Default.GetString(saltBytes);
            string expectedHashString =
                        ComputeHash(plainText, hashAlgorithm, saltValue);
