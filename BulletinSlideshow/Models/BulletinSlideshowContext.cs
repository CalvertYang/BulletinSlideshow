...
{
    public class BulletinSlideshowContext : DbContext
    {
        ...
        // 
        // System.Data.Entity.Database.SetInitializer(new System.Data.Entity.DropCreateDatabaseIfModelChanges<BulletinSlideshow.Models.BulletinSlideshowContext>());

        public BulletinSlideshowContext() : base("name=BulletinSlideshowContext")
        {
        }
